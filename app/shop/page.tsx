...
export default async function ShopPage() {
  try {
    ...
    if (!res.ok) {
      ...
      return (
        <main className="p-6 md:p-10 space-y-4">
          <h1 className="text-3xl font-semibold text-white">Shop</h1>
          <div className="rounded-2xl bg-red-500/10 ring-1 ring-red-500/30 p-4 text-white">
            <div className="font-medium">Shop page crashed</div>
            <div className="mt-2 text-sm text-white/80">
              Printify products API failed: {res.status} {res.statusText}
            </div>
    ...
    // { ok:true, status:200, data: { current_page:1, data:[products...] } }
...
// Forces TS to treat this file as a module in CI/Vercel
export {};
